...
const colorApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getAllColorClient: builder.query<IColor, void>({
      query: () => `/colors`,
      providesTags: ['Color']
    }),
...
export const {
  useAddColorMutation,
  useGetAllColorClientQuery,
  useGetColorsQuery,
  useSearchColorsQuery, useRemoveColorMutation, useUpdateColorMutation, useGetColorQuery } = colorApi;

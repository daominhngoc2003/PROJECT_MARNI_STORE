        ...
        >
          <div className="">
            ...
            <div className="text-red-500">
              {errors?.user_fullname && errors?.user_fullname?.message as any}
            </div>
          </div>
          <div className="">
            <label
            ...
            />
            <div className="text-red-500">
              {errors?.user_username && errors?.user_username?.message as any}
            </div>
          </div>
          <div className="">
          ...
          <div className="">
            ...
            />
            <div className="text-red-500">
              {errors?.user_phone && errors?.user_phone?.message as any}
            </div>
          </div>
          <article
